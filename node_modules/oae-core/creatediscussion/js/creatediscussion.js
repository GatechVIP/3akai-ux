...
define(['jquery', 'oae.core'], function ($, oae) {
    ...
    return function (uid) {
        ...
        var setUpCreateDiscussion = function() {
            $(document).on('click', '#qa-toggle-button', $rootel, function() {
	        if ($('#qa-toggle-button').html() === 'QA') {
		    $('#qa-toggle-button').html('Discussion');
		    $('#discussion-title').html('Question Title');
		    $('#creatediscussion-name').attr('placeholder', 'What would you like to call your question?');
		    $('#discussion-topic').html('Question');
		    $('#creatediscussion-topic').attr('placeholder', 'What is your question?');
		} else {
		    $('#qa-toggle-button').html('QA');
		    $('#discussion-title').html('Discussion Title');
		    $('#creatediscussion-name').attr('placeholder', 'What would you like to call your discussion?');
		    $('#discussion-topic').html('Discussion Topic');
		    $('#creatediscussion-topic').attr('placeholder', 'What would you like to discuss about?');
		}
	    });
	    $(document).on('click', '#creatediscussion-create', $rootel, function() {
	        createDiscussion($('#qa-toggle-button').html() === 'Discussion');
	    });
        };
         ...
         */
        var createDiscussion = function(isQa) {
            // Disable the form
            ...
            oae.api.discussion.createDiscussion(displayName, discussionTopic, visibility, [], members, isQa, function (err, data) {
