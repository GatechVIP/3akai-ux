    ...
    return function (uid) {
        ...
        var setUpCreateDiscussion = function() {
            ...
            $(document).on('click', '#qa-toggle-button', $rootel, function() {
                ...
                $('#creatediscussion-name').attr('placeholder', 'What is your question topic?');
                $('#discussion-topic').html('Question');
                $('#creatediscussion-topic').attr('placeholder', 'What is your question?');
            });
            
            $(document).on('click', '#discuss-toggle-button', $rootel, function() {
                qa = false;
                $('#discussion-title').html('Discussion Title');
                $('#creatediscussion-name').attr('placeholder', 'What is your discussion topic?');
                $('#discussion-topic').html('Discussion');
