...
define(['jquery', 'oae.core'], function($, oae) {
    ...
    return function(uid, showSettings) {
        ...
        var setUpSetAnswer = function() {
            $rootel.on('click', '.comment-vote-answer-button', function() {
                var mediaBody = $(this).parent().parent();
                var comment = mediaBody.clone().children().remove().end().text();
                comment = $.trim(comment);
                $('#discussion-answer').text(comment);
                $('#discussion-answer-container').show();
            });
        };
