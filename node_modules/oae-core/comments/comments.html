            ...
            <div class="media-body">
                ...
                {else}
                    <div class="pull-right">
                        {if !oae.data.me.anon && isQa === 'true' && comment.level < 1}
                        ...
                        {if canManage || comment.createdBy.id === oae.data.me.id}
                            ...
                            {if isQa === 'true'}
                                <button type="button" class="btn btn-link comment-vote-answer-button" data-id="${comment.created}" title="Vote Answer">
                                    <span class="oae-aural-text">Vote Answer</span>
